...
The resource lists use a blocky/heavy box style inspired by tmux and nvim statuslines, instead of the rounded borders used by `pi-homescreen`.
...
On wide terminals, the ASCII logo sits on the left and the resource cards render in a single stacked column to its right:
